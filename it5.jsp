<%-- 
    Document   : it5
    Created on : Dec 29, 2023, 2:19:45 AM
    ...
    <body>
        ...
        <section id="itemdetail" class="section-p1">
            <div class="single-item-image">
                <img src="https://www.babycheramy.lk/admin/uploads/products/propic1/img006_1599550090.jpg" width="100%" id="Mainimg">
            </div>
            <div class="single-item-detail">
                <h6 style="color: #009933;">Shop/Baby Products</h6>
                <h4>Baby Cheremy</h4>
                <p>Baby Cream Classic</p>
                <p>100ml</p>
                <h2>Rs.560/=</h2>
