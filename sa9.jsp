<%-- 
    Document   : sa9
    Created on : Dec 29, 2023, 4:02:26 PM
    ...
    <body>
        ...
        <section id="itemdetail" class="section-p1">
            <div class="single-item-image">
                <img src="https://objectstorage.ap-mumbai-1.oraclecloud.com/n/softlogicbicloud/b/cdn/o/products/116218--01--1555692003.webp" width="100%" id="Mainimg">
            </div>
            <div class="single-item-detail">
                <h6 style="color: #009933;">Shop/Cooking Essentials</h6>
                <h4>Raigam</h4>
                <p>Coconut Toddy Vinegar</p>
                <p>350ml</p>
                <h2>Rs.172/=</h2>
