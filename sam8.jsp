<%-- 
    Document   : sam8
    Created on : Dec 29, 2023, 4:23:10 PM
    ...
    <body>
        ...
        <section id="itemdetail" class="section-p1">
            <div class="single-item-image">
                <img src="https://objectstorage.ap-mumbai-1.oraclecloud.com/n/softlogicbicloud/b/cdn/o/products/600-600/100114--01--1643471917.jpeg" width="100%" id="Mainimg">
            </div>
