<%-- 
    Document   : sa14
    Created on : Dec 29, 2023, 4:03:04 PM
    ...
    <body>
        ...
        <section id="itemdetail" class="section-p1">
            <div class="single-item-image">
                <img src="http://www.edinborough.lk/storage/app/uploads/public/60c/9a4/c34/60c9a4c342bce516198879.png" width="100%" id="Mainimg">
            </div>
