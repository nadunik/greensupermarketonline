<%-- 
    Document   : itm9
    Created on : Dec 29, 2023, 1:32:28 AM
    ...
    <body>
        ...
        <section id="itemdetail" class="section-p1">
            <div class="single-item-image">
                <img src="https://objectstorage.ap-mumbai-1.oraclecloud.com/n/softlogicbicloud/b/cdn/o/products/112712--01--1555686805.webp" width="100%" id="Mainimg">
            </div>
            <div class="single-item-detail">
                <h6 style="color: #009933;">Shop/Household</h6>
                <h4>Harpic</h4>
                <p>Harpic Toilet Bowl Cleaner</p>
                <p>500ml</p>
                <h2>Rs.400/=</h2>
