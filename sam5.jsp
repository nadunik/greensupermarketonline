<%-- 
    Document   : sam5
    Created on : Dec 29, 2023, 4:22:46 PM
    ...
    <body>
        ...
        <section id="itemdetail" class="section-p1">
            <div class="single-item-image">
                <img src="https://objectstorage.ap-mumbai-1.oraclecloud.com/n/softlogicbicloud/b/cdn/o/products/100030--01--1555580979.jpeg" width="100%" id="Mainimg">
            </div>
