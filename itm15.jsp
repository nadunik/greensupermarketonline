<%-- 
    Document   : itm15
    Created on : Dec 29, 2023, 1:33:22 AM
    ...
    <body>
        ...
        <section id="itemdetail" class="section-p1">
            <div class="single-item-image">
                <img src="https://objectstorage.ap-mumbai-1.oraclecloud.com/n/softlogicbicloud/b/cdn/o/products/400228--01--1650444890.webp" width="100%" id="Mainimg">
            </div>
