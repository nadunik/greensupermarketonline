<%-- 
    Document   : sin2
    Created on : Dec 28, 2023, 9:37:12 PM
    ...
    <body>
        ...
        <section id="itemdetail" class="section-p1">
            <div class="single-item-image">
                <img src="https://objectstorage.ap-mumbai-1.oraclecloud.com/n/softlogicbicloud/b/cdn/o/products/140-140/115687--01--1555691844.webp" width="100%" id="Mainimg">
            </div>
            <div class="single-item-detail">
                <h6 style="color: #009933;">Shop/Food</h6>
                <h4>Mr Potato</h4>
                <p>Potato Crisp Original Can</p>
                <p>100g</p>
                <h2>Rs.790/=</h2>
