<%-- 
    Document   : sin3
    Created on : Dec 28, 2023, 9:37:22 PM
    ...
    <body>
        ...
        <section id="itemdetail" class="section-p1">
            <div class="single-item-image">
                <img src="https://objectstorage.ap-mumbai-1.oraclecloud.com/n/softlogicbicloud/b/cdn/o/products/140-140/123415--01--1692681792.webp" width="100%" id="Mainimg">
            </div>
