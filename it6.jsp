<%-- 
    Document   : it6
    Created on : Dec 29, 2023, 2:19:54 AM
    ...
    <body>
        ...
        <section id="itemdetail" class="section-p1">
            <div class="single-item-image">
                <img src="https://www.babycheramy.lk/admin/uploads/products/propic1/img028_1599553371.jpg" width="100%" id="Mainimg">
            </div>
            <div class="single-item-detail">
                <h6 style="color: #009933;">Shop/Baby Products</h6>
                <h4>Baby Cheremy</h4>
                <p>Laundry Wash Powder</p>
                <p>1kg</p>
                <h2>Rs.825/=</h2>
