<%-- 
    Document   : si13
    Created on : Dec 28, 2023, 7:34:11 PM
    ...
    <body>
        ...
        <section id="itemdetail" class="section-p1">
            <div class="single-item-image">
                <img src="https://objectstorage.ap-mumbai-1.oraclecloud.com/n/softlogicbicloud/b/cdn/o/products/140-140/116991--01--1595587435.webp" width="100%" id="Mainimg">
            </div>
            <div class="single-item-detail">
                <h6 style="color: #009933;">Shop/Cosmetics</h6>
                <h4>Prevense</h4>
                <p>Gold Eye Treatment Gel</p>
                <p>30ml</p>
                <h2>Rs.3000/=</h2>
