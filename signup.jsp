<%-- 
    Document   : signup
    Created on : Dec 30, 2023, 3:26:57 AM
...
<html>
    ...
    <body>
        ...
        <section id="Signupheader"><!--hero section -->
            <h4 style="color: #ffffff; font-size:54px;">#Stay-Tuned</h4>
            <p style="color: #cccccc; font-size: 24px;">For our latest news & discount details!!</p>
            <br>
        </section>
