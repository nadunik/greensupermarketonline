<%-- 
    Document   : si3
    Created on : Dec 28, 2023, 7:31:49 PM
    ...
    <body>
        ...
        <section id="itemdetail" class="section-p1">
            <div class="single-item-image">
                <img src="https://objectstorage.ap-mumbai-1.oraclecloud.com/n/softlogicbicloud/b/cdn/o/products/140-140/119530--01--1631628970.webp" width="100%" id="Mainimg">
            </div>
            <div class="single-item-detail">
                <h6 style="color: #009933;">Shop/Cosmetics</h6>
                <h4>Enchanteur</h4>
                <p>Body Lotion Charming</p>
                <p>100ml</p>
                <h2>Rs.810/=</h2>
