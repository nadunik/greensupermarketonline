<%-- 
    Document   : si4
    Created on : Dec 28, 2023, 7:32:01 PM
    ...
    <body>
        ...
        <section id="itemdetail" class="section-p1">
            <div class="single-item-image">
                <img src="https://objectstorage.ap-mumbai-1.oraclecloud.com/n/softlogicbicloud/b/cdn/o/products/140-140/120718--01--1631628979.webp" width="100%" id="Mainimg">
            </div>
            <div class="single-item-detail">
                <h6 style="color: #009933;">Shop/Cosmetics</h6>
                <h4>Nature's Secret</h4>
                <p>Body Lotion Soothing Care with Aloe Vera</p>
                <p>100ml</p>
                <h2>Rs.390/=</h2>
