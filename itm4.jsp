<%-- 
    Document   : itm4
    Created on : Dec 29, 2023, 1:31:40 AM
    ...
    <body>
        ...
        <section id="itemdetail" class="section-p1">
            <div class="single-item-image">
                <img src="https://objectstorage.ap-mumbai-1.oraclecloud.com/n/softlogicbicloud/b/cdn/o/products/112933--01--1697601628.webp" width="100%" id="Mainimg">
            </div>
            <div class="single-item-detail">
                <h6 style="color: #009933;">Shop/Household</h6>
                <h4>Sunlight</h4>
                <p>Sunlight Yellow Soap</p>
                <p>115g</p>
                <h2>Rs.150/=</h2>
