<%-- 
    Document   : si2
    Created on : Dec 28, 2023, 7:31:33 PM
    ...
    <body>
        ...
        <section id="itemdetail" class="section-p1">
            <div class="single-item-image">
                <img src="https://objectstorage.ap-mumbai-1.oraclecloud.com/n/softlogicbicloud/b/cdn/o/products/140-140/117692--01--1697601702.webp" width="100%" id="Mainimg">
            </div>
            <div class="single-item-detail">
                <h6 style="color: #009933;">Shop/Cosmetics</h6>
                <h4>Vaseline</h4>
                <p>Body Lotion Calming Lavender</p>
                <p>400ml</p>
                <h2>Rs.2300/=</h2>
