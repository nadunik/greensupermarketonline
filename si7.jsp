<%-- 
    Document   : si7
    Created on : Dec 28, 2023, 7:32:53 PM
    ...
    <body>
        ...
        <section id="itemdetail" class="section-p1">
            <div class="single-item-image">
                <img src="https://objectstorage.ap-mumbai-1.oraclecloud.com/n/softlogicbicloud/b/cdn/o/products/140-140/123090--01--1673931630.webp" width="100%" id="Mainimg">
            </div>
            <div class="single-item-detail">
                <h6 style="color: #009933;">Shop/Cosmetics</h6>
                <h4>Earth Essence</h4>
                <p>Herbal Sunburn Lotion</p>
                <p>150ml</p>
                <h2>Rs.1160/=</h2>
