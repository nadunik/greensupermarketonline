<%-- 
    Document   : si11
    Created on : Dec 28, 2023, 7:33:43 PM
    ...
    <body>
        ...
        <section id="itemdetail" class="section-p1">
            <div class="single-item-image">
                <img src="https://objectstorage.ap-mumbai-1.oraclecloud.com/n/softlogicbicloud/b/cdn/o/products/140-140/119226--01--1630434151.webp" width="100%" id="Mainimg">
            </div>
            <div class="single-item-detail">
                <h6 style="color: #009933;">Shop/Cosmetics</h6>
                <h4>Dreamron</h4>
                <p>Facial Scrub Cucumber</p>
                <p>180ml</p>
                <h2>Rs.690/=</h2>
