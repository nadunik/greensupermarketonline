<%-- 
    Document   : si1
    Created on : Dec 28, 2023, 7:26:49 PM
    ...
    <body>
        ...
        <section id="itemdetail" class="section-p1">
            <div class="single-item-image">
                <img src="https://objectstorage.ap-mumbai-1.oraclecloud.com/n/softlogicbicloud/b/cdn/o/products/140-140/112156--01--1697601026.webp" width="100%" id="Mainimg">
            </div>
            <div class="single-item-detail">
                <h6 style="color: #009933;">Shop/Cosmetics</h6>
                <h4>Vaseline</h4>
                <p>Body Lotion Cocoa Glow</p>
                <p>100ml</p>
                <h2>Rs.780/=</h2>
