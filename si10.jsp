<%-- 
    Document   : si10
    Created on : Dec 28, 2023, 7:33:31 PM
    ...
    <body>
        ...
        <section id="itemdetail" class="section-p1">
            <div class="single-item-image">
                <img src="https://objectstorage.ap-mumbai-1.oraclecloud.com/n/softlogicbicloud/b/cdn/o/products/140-140/118816--01--1656939782.webp" width="100%" id="Mainimg">
            </div>
            <div class="single-item-detail">
                <h6 style="color: #009933;">Shop/Cosmetics</h6>
                <h4>4Ever</h4>
                <p>Face Wash Rose Anti Acne</p>
                <p>100ml</p>
                <h2>Rs.590/=</h2>
