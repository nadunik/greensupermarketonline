<%-- 
    Document   : sam11
    Created on : Dec 29, 2023, 4:23:31 PM
    ...
    <body>
        ...
        <section id="itemdetail" class="section-p1">
            <div class="single-item-image">
                <img src="https://objectstorage.ap-mumbai-1.oraclecloud.com/n/softlogicbicloud/b/cdn/o/products/600-600/115951--01--1555691997.jpeg" width="100%" id="Mainimg">
            </div>
            <div class="single-item-detail">
                <h6 style="color: #009933;">Shop/Beverages</h6>
                <h4>Mountain Dew</h4>
                <p>Mountain Dew mega</p>
                <p>1.5l</p>
                <h2>Rs.350/=</h2>
