<%-- 
    Document   : sa5
    Created on : Dec 29, 2023, 4:01:56 PM
    ...
    <body>
        ...
        <section id="itemdetail" class="section-p1">
            <div class="single-item-image">
                <img src="https://www.grocerylanka.com/cdn/shop/products/Wijaya-Curry-Powder-500g_1024x1024.jpg?v=1541738888" width="100%" id="Mainimg">
            </div>
