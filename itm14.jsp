<%-- 
    Document   : itm14
    Created on : Dec 29, 2023, 1:33:11 AM
    ...
    <body>
        ...
        <section id="itemdetail" class="section-p1">
            <div class="single-item-image">
                <img src="https://objectstorage.ap-mumbai-1.oraclecloud.com/n/softlogicbicloud/b/cdn/o/products/112406--01--1556128432.webp" width="100%" id="Mainimg">
            </div>
