<%-- 
    Document   : sa13
    Created on : Dec 29, 2023, 4:02:57 PM
    ...
    <body>
        ...
        <section id="itemdetail" class="section-p1">
            <div class="single-item-image">
                <img src="http://www.edinborough.lk/storage/app/uploads/public/625/d5f/3aa/625d5f3aa4db5590694153.png" width="100%" id="Mainimg">
            </div>
