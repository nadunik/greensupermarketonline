<%-- 
    Document   : itm11
    Created on : Dec 29, 2023, 1:32:47 AM
    ...
    <body>
        ...
        <section id="itemdetail" class="section-p1">
            <div class="single-item-image">
                <img src="https://objectstorage.ap-mumbai-1.oraclecloud.com/n/softlogicbicloud/b/cdn/o/products/112698--01--1555686804.webp" width="100%" id="Mainimg">
            </div>
            <div class="single-item-detail">
                <h6 style="color: #009933;">Shop/Household</h6>
                <h4>Dettol</h4>
                <p>Dettol Antiseptic Disinfectant</p>
                <p>1l</p>
                <h2>Rs.1480/=</h2>
