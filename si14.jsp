<%-- 
    Document   : si14
    Created on : Dec 28, 2023, 7:34:24 PM
    ...
    <body>
        ...
        <section id="itemdetail" class="section-p1">
            <div class="single-item-image">
                <img src="https://lyskin.com/wp-content/uploads/2023/07/Lyskin-Neutrogena-Hydra-Boost-Urban-Protact-SPF25-NTG00051-01.webp" width="100%" id="Mainimg">
            </div>
            <div class="single-item-detail">
                <h6 style="color: #009933;">Shop/Cosmetics</h6>
                <h4>Neutrogena</h4>
                <p>Urban Protect Hydrating Facial Fluid</p>
                <p>50ml</p>
                <h2>Rs.7500/=</h2>
