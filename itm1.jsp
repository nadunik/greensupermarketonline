<%-- 
    Document   : itm1
    Created on : Dec 29, 2023, 1:30:22 AM
    ...
    <body>
        ...
        <section id="itemdetail" class="section-p1">
            <div class="single-item-image">
                <img src="https://objectstorage.ap-mumbai-1.oraclecloud.com/n/softlogicbicloud/b/cdn/o/products/112930--01--1697601625.webp" width="100%" id="Mainimg">
            </div>
            <div class="single-item-detail">
                <h6 style="color: #009933;">Shop/Household</h6>
                <h4>Vim</h4>
                <p>Vim dishwash liquid</p>
                <p>500ml</p>
                <h2>Rs.340/=</h2>
