<%-- 
    Document   : sam13
    Created on : Dec 29, 2023, 4:23:45 PM
    ...
    <body>
        ...
        <section id="itemdetail" class="section-p1">
            <div class="single-item-image">
                <img src="https://www.spar.lk/cdn/shop/products/elephant-house-egb-1l-beverages-533.jpg?v=1658466292" width="100%" id="Mainimg">
            </div>
