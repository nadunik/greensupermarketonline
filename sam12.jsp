<%-- 
    Document   : sam12
    Created on : Dec 29, 2023, 4:23:37 PM
    ...
    <body>
        ...
        <section id="itemdetail" class="section-p1">
            <div class="single-item-image">
                <img src="https://objectstorage.ap-mumbai-1.oraclecloud.com/n/softlogicbicloud/b/cdn/o/products/600-600/100029--01--1555580979.jpeg" width="100%" id="Mainimg">
            </div>
            <div class="single-item-detail">
                <h6 style="color: #009933;">Shop/Beverages</h6>
                <h4>Elephant House</h4>
                <p>Lemonade</p>
                <p>1l</p>
                <h2>Rs.250/=</h2>
