<%-- 
    Document   : sa7
    Created on : Dec 29, 2023, 4:02:11 PM
    ...
    <body>
        ...
        <section id="itemdetail" class="section-p1">
            <div class="single-item-image">
                <img src="https://www.kapruka.com/cdn-cgi/image/width=700,quality=93,f=auto/shops/specialGifts/additionalImages/large/1595836627305_salt_m.jpg" width="100%" id="Mainimg">
            </div>
